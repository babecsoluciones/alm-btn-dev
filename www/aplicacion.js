...
function onSuccessGPS(position) {
    ...
    var cmbLat = document.querySelectorAll("[id^=tdLat]");
    var cmbLng = document.querySelectorAll("[id^=tdLng]");

    cmbLat.forEach(function(nodo){
        nodo.innerHTML = position.coords.latitude;
    });

    cmbLng.forEach(function(nodo){
        nodo.innerHTML = position.coords.longitude;
    });

    var cmbLat = document.querySelectorAll("[id^=tLat]");
    var cmbLng = document.querySelectorAll("[id^=tLng]");
